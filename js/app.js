...
if(form_simulador){
  ...
  const fecha_solicitud = document.getElementById('fecha-solicitud')
  const fecha_cuota_uno = document.getElementById('fecha-cuota-uno')
  ...
  //Tipo programa
  const tipo_programa = document.getElementById('tipo-programa')

  tipo_programa.addEventListener('change', function() {
          //Pregrado
          if (this.value == 1) {
            crearOpciones(6, cont_cuotas)
          } else if (this.value == 2) {
          //Posgrado
            crearOpciones(12, cont_cuotas)
          }   
  })
